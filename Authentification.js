        ...
        guilds.forEach(function(guild){
            table += `<tr style="display: block; float: left">
                        <td style="display: block"> 
                            <img src="https://cdn.discordapp.com/icons/${guild["id"]}/${guild["icon"]}.png" onclick="window.location.replace('http://5.45.104.29/Mops-WebInterface/options.html?guild=${guild["id"]}')" style="width: 25%; height: 25%" title="${guild["name"]}">
                        </td>
                      </tr>`;
        });
        table += "</table>"
