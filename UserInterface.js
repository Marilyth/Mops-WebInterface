...
function switchToGuild(guild) {
    ...
    row.insertCell(-1).innerHTML = `<img class="roundSquare" style="width: 0px; height: 0px; transition: all 0.3s ease; width: 128px; height: 128px;" src="https://cdn.discordapp.com/icons/${guild["id"]}/${guild["icon"]}.png">`;
