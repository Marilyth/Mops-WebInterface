...
function switchToGuild(guild) {
    ...
    row.insertCell(-1).innerHTML = `<img class="roundSquare" style="width: 0%; height: 0%; transition: all 0.3s ease; width: 100%; height: 100%" src="https://cdn.discordapp.com/icons/${guild["id"]}/${guild["icon"]}.png">`;
